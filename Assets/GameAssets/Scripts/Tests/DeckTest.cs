...
public class DeckTest : MonoBehaviour 
{
    void Start()
    {
        DeckFactory.GreateDeck(DeckCardType.Poker, DeckType.Random, new Vector3(-10,0,0));
        DeckFactory.GreateDeck(DeckCardType.Poker, DeckType.Random, new Vector3(+10, 0, 0));
        ...
        PileFactory.GreatePile(PileType.Random, VisableCardStyle.Top, PickStyle.Line, new Vector3(-30, +30, 0));
    }
}
